...
# ── SAVE MODEL ──
model.save('data/ctgan_10percent.pkl')
print("Saved ctgan_10percent.pkl")

# ── EVALUATE ──
print("\nGenerating 50,000 synthetic orders...")
synthetic = model.sample(num_rows=50000)
synthetic.to_csv(
    'data/synthetic_10percent.csv', index=False)
...
print("Saved: data/ctgan_10percent.pkl")
print("       data/synthetic_10percent.csv")